...
tgt_path = config['path']['tgt_path']
src_img_path = config['path']['src_img_path']
train_json_path = config['path']['train_json_path']
val_json_path = config['path']['val_json_path']
...
os.makedirs(os.path.join(tgt_path,'images'),exist_ok=True)
os.makedirs(os.path.join(tgt_path,'iamges/train'),exist_ok=True)
os.makedirs(os.path.join(tgt_path,'images/val'),exist_ok=True)
os.makedirs(os.path.join(tgt_path,'iamges/test'),exist_ok=True)
os.makedirs(os.path.join(tgt_path,'labels'),exist_ok=True)
os.makedirs(os.path.join(tgt_path,'labels/train'),exist_ok=True)
os.makedirs(os.path.join(tgt_path,'labels/val'),exist_ok=True)
os.makedirs(os.path.join(tgt_path,'labels/test'),exist_ok=True)

            
train_yolo_converter = COCO2YOLO(src_img_dir=src_img_path, json_file=train_json_path,
